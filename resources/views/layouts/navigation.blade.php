        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="items-center" src="{{ asset('logo.png') }}" alt="" width="35"
                            height="35">
                    </a>
                </div>
                ...
                @endif
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('bukti-pajak.index')" :active="request()->routeIs('bukti-pajak.index')">
                        {{ __('Cetak Laporan') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border-0 border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
